...
if [[ $target == "H" ]]; then
    ...
    inFile="/work/clas12/rg-m/Cx4/prod1.4/dst/recon/015188/rec_clas_015188.evio.00001.hipo";
elif [[ $target == "Ca40" ]]; then
    inFile="/work/clas12/rg-m/40Ca/prod1.4/dst/recon/015392/rec_clas_015392.evio.00001.hipo";
elif [[ $target == "Ca48" ]]; then
    inFile="/work/clas12/rg-m/48Ca/prod1.4/dst/recon/015832/rec_clas_015832.evio.00001.hipo";
elif [[ $target == "Ar40" ]]; then
    inFile="/work/clas12/rg-m/LAr/prod1.5/dst/recon/015795/rec_clas_015795.evio.00001.hipo";
elif [[ $target == "Sn120" ]]; then
    inFile="/work/clas12/rg-m/Snx4/prod1.4/dst/recon/015327/rec_clas_015327.evio.00001.hipo";
fi
